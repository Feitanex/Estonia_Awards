...
<div>
        ...
        <div style="display: flex; align-items: flex-start;">
            ...
            <div style="width: 60%; margin-left: 5%; margin-top:6%; font-size:20px; font-family:Courier New; color:#7B7B7B;">
                ...
                <button style="border: 2px solid transparent; width:10%; height:35px; color:white; background-color:#ABA49D ; border-radius: 98px; font-size:15px; font-family:Courier New; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5);"><a style="color:white;">заказать</a></button>
            </div>
