...
<div class="container mt-4" >
    <div style="position: relative;">
        ...
        <button style="border: 2px solid transparent; width:140px; height:35px; color:white; background-color:#ABA49D ; border-radius: 98px;position: absolute; top: 55%; left: 90%; transform: translate(-50%, -50%); z-index: 1;font-size:15px; font-family:Courier New; box-shadow: 10px 10px 0px rgba(0, 0, 0, 0.5);"><a style="color:white;">перейти</a></button>
    ...
    <div class="container mt-4">
        ...
        <div style="margin-left: -400px;margin-right: -366px; height: 1000px;background-color:#D9D9D9;">
            ...
            <div style="position: absolute; top: 150%; left: 3%; margin-left: 3%; width: 62%;height: 25%; background-color: #9C9289; border-radius: 20px; box-shadow: 10px 10px 0px rgba(0, 0, 0, 0.5);">
            ...
            <div style="position: absolute; top: 190%; left: 3%; margin-left: 32%; width: 62%;height: 48%; background-color: #9C9289; border-radius: 20px; box-shadow: 10px 10px 0px rgba(0, 0, 0, 0.5);">
