...
<div class="box-header with-border">
    ...
    <div class="add">
        <a href="{{ url('/users') }}" class="btn btn-primary btn-sm btn-flat" style="border-radius: 98px; background-color:#ABA49D; border:transparent; font-family:Courier New; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5);">
        ...
        <div class="col-lg-9 margin-tb">
            ...
            <form action="{{ route('edituser.update', ['user' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        <label for="email" class="col-sm-3 control-label" style="font-family:Courier New;">Роль:</label>
                        <div class="col-sm-6">
                ...
                <button type="submit" class="btn btn-default" style="border-radius: 98px;border:transparent; font-family:Courier New; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5);">
					<i class="fa fa-btn fa-plus"></i> Обновить данные
                </div>
            </form>
        </div>
    </div>
