...
<div class="box-header with-border">
    ...
    <div class="add">
        <a href="/users" class="btn btn-primary btn-sm btn-flat" style="border-radius: 98px; background-color:#ABA49D; border:transparent; font-family:Courier New; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5);">
        ...
        <div class="col-lg-9 margin-tb">
            ...
            <form action="{{ url('adduser') }}" method="POST" class="form-horizontal">
                ...
                <button type="submit" class="btn btn-default" style="border-radius: 98px;border:transparent; font-family:Courier New; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.5);">
					<i class="fa fa-btn fa-plus"></i> Добавить нового пользователя
				</button>		
                </div>
            </form>
        </div>
